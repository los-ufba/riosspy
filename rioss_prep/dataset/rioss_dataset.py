...
class RiossDataset(Dataset):
    def __init__(self, list_paths, win_size, class_weights, transforms, label_order_path, overlap=None, filter_max=1, filter_min=0, wind_speed=False):
    ...
    def get_input_label(self, file_name, coord):
        ...
        if self.wind_speed:
            wind_speed = netcdf_ds.wind_speed.isel(y=y_slice, x=x_slice).values
